...
void handleStatus() {
  ...
  if (myConfig.autoModeActive) {
    unsigned long elapsed = millis() - lastAutoToggleTime;

    if (elapsed < myConfig.autoIntervalMs) {
      remainingMs = myConfig.autoIntervalMs - elapsed;
    }
  }
